            ...
            {messages.map((msg) => (
              ...
              >
                ...
                <div className={`flex flex-col gap-2 max-w-[80%] ${msg.sender === 'user' ? 'items-end' : 'items-start'}`}>
                  ...
                  {/* RENDER TEXT MESSAGE */}
                  {msg.text && (
                    <div className={`px-6 py-4 rounded-[24px] shadow-sm text-[15px] sm:text-[16px] leading-relaxed whitespace-pre-wrap break-words font-medium w-full text-left ${msg.sender === 'user'
